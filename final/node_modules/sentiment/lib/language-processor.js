...
var chLanguage = require('../languages/ch/index');
// Add emojis
...
module.exports = {
    ...
    distinguishScoringStrategy: function(languageCode, curScore, curWord, tokenMood) {
        var language = this.getLanguage(languageCode);
        var scoringStrategy = language.scoringStrategy;
        return scoringStrategy.distinguish(curScore, curWord, tokenMood);
    }
};
